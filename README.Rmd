...
- [data](./data): test data using dummies datasets.
...
```
devtools::install_github('warelab/NECorr', build_vignettes=TRUE, dependencies=FALSE, upgrade_dependencies=FALSE)  # install NECorr with the vignettes
```
